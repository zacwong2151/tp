 ...
 */
public class EventCreateCommandIntegrationTest {
    ...
    public void execute_newEvent_success() {
        ...
        assertCommandSuccess(new EventCreateCommand(validEvent), model,
                String.format(EventCreateCommand.MESSAGE_SUCCESS, Messages.format(validEvent)),
                expectedModel);
    }

    @Test
    public void execute_duplicateEvent_throwsCommandException() {
        Event eventInList = model.getEventStorage().getEventList().get(0);
        assertCommandFailure(new EventCreateCommand(eventInList), model,
                EventCreateCommand.MESSAGE_DUPLICATE_EVENT);
    }

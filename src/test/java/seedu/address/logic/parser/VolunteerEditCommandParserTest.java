...
public class VolunteerEditCommandParserTest {

    private static final String SKILL_EMPTY = " " + PREFIX_SKILL;

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, VolunteerEditCommand.MESSAGE_USAGE);

    private VolunteerEditCommandParser parser = new VolunteerEditCommandParser();
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", VolunteerEditCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_invalidValue_failure() {
        ...
        // while parsing {@code PREFIX_SKILL} alone will reset the skills of the {@code Volunteer} being edited,
        // parsing it together with a valid skill results in error
        assertParseFailure(parser, "1" + SKILL_DESC_FRIEND + SKILL_DESC_HUSBAND + SKILL_EMPTY, Skill.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + SKILL_DESC_FRIEND + SKILL_EMPTY + SKILL_DESC_HUSBAND, Skill.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + SKILL_EMPTY + SKILL_DESC_FRIEND + SKILL_DESC_HUSBAND, Skill.MESSAGE_CONSTRAINTS);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditVolunteerDescriptorBuilder().withSkills(VALID_SKILL_FRIEND).build();
        expectedCommand = new VolunteerEditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }

 ...
 * outside of the EventShowCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the EventShowCommand, and therefore we test only one of them.
...
public class EventShowCommandParserTest {
    ...
    public void parse_validArgs_returnsEventShowCommand() {
        assertParseSuccess(parser, "1", new EventShowCommand(INDEX_FIRST));
    }

...
public class JsonSerializableVolunteerStorageTest {
    ...
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        JsonSerializableVolunteerStorage dataFromFile = JsonUtil.readJsonFile(INVALID_PERSON_FILE,
                JsonSerializableVolunteerStorage.class).get();
    ...
    public void toModelType_duplicatePersons_throwsIllegalValueException() throws Exception {
        JsonSerializableVolunteerStorage dataFromFile = JsonUtil.readJsonFile(DUPLICATE_PERSON_FILE,
                JsonSerializableVolunteerStorage.class).get();
        assertThrows(IllegalValueException.class, JsonSerializableVolunteerStorage.MESSAGE_DUPLICATE_PERSON,

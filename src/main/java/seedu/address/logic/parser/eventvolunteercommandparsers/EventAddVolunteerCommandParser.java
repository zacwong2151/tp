 ...
 */
public class EventAddVolunteerCommandParser implements Parser<EventAddVolunteerCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the EventAddVolunteerCommand
     * and returns an EventAddVolunteerCommand object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */
    public EventAddVolunteerCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            return new EventAddVolunteerCommand(assignedEventIndex, assignedVolunteerIndex);
        } catch (ParseException pe) {
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, EventAddVolunteerCommand.MESSAGE_USAGE), pe);
        }
    }

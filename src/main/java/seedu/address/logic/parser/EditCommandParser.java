 ...
 */
public class EditCommandParser implements Parser<VolunteerEditCommand> {
    ...
    public VolunteerEditCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, VolunteerEditCommand.MESSAGE_USAGE), pe);
        }

...
| `* * *`  | user                                       | delete a volunteer              | remove entries that I no longer need                                   |
| `* * *`  | user                                       | find a volunteer by eventName        | locate details of volunteers without having to go through the entire list |
| `* *`    | user                                       | hide private contact details | minimize chance of someone else seeing them by accident                |
| `*`      | user with many volunteers in the address book | sort volunteers by eventName         | locate a volunteer easily                                                 |

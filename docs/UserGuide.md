...
| **Add a volunteer to an event**               | `eaddv vid/VOLUNTEER_ID /to eid/EVENT_ID`<br> e.g., `eaddv vid/1 /to eid/3` <br> Alternatively, `eaddv vn/VOLUNTEER_NAME /to en/EVENT_NAME` <br> e.g., `eaddv vn/Betsy Crowe /to en/Fundraising for needy families`                                                                    |
...
| **Remove a volunteer from an event**          | `eremovev vid/VOLUNTEER_ID /from eid/EVENT_ID`<br> e.g., `eremovev vid/3 /from eid/4` <br> Alternatively, `eremovev vn/VOLUNTEER_NAME /from en/EVENT_NAME` <br> e.g., `eremovev vn/John Lim /from en/October beach clean up`                                                           |
